		...
		<div class="tab-pane" id="tab_1">
				<div class="portlet box blue">
					<div class="portlet-title">
						<div class="caption">
							<i class="glyphicon glyphicon-refresh"></i>Change State: Disable ->Active
						</div>
					</div>
					</div>
								...
								<tr id="${listState.id}">
									...
									<td>
										<p data-placement="top" data-toggle="tooltip" title="Verify">
											<button class="btn btn-primary btn-xs changeState">
												<i class="glyphicon glyphicon-refresh"></i>Change State</button>
										</p>
									</td>
								</tr>
							</c:forEach>
