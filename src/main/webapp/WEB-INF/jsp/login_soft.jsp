...
<!-- BEGIN THEME STYLES -->
<link href="components-md.css" id="style_components" rel="stylesheet" type="text/css"/>
<link href="plugins-md.css" rel="stylesheet" type="text/css"/>
<link href="layout.css" rel="stylesheet" type="text/css"/>
<link id="style_color" href="default.css" rel="stylesheet" type="text/css"/>
...
<script src="jquery.cokie.min.js" type="text/javascript"></script>
<!-- END CORE PLUGINS -->
...
<script src="login-soft.js" type="text/javascript"></script>
<!-- END PAGE LEVEL SCRIPTS -->
<script>
